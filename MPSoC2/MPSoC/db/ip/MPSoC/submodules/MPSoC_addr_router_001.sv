...
(
    ...
    localparam PAD5 = log2ceil(64'h31068 - 64'h31060);
    localparam PAD6 = log2ceil(64'h31070 - 64'h31068);
    localparam PAD7 = log2ceil(64'h31078 - 64'h31074);
    // -------------------------------------------------------
    ...
    always @* begin
        ...
        // ( 0x31068 .. 0x31070 )
        if ( {address[RG:PAD6],{PAD6{1'b0}}} == 18'h31068 ) begin
            src_channel = 14'b00001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
        end

        // ( 0x31074 .. 0x31078 )
        if ( {address[RG:PAD7],{PAD7{1'b0}}} == 18'h31074 ) begin
