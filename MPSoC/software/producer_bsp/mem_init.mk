...
# Memory: onchip_memdata0
MEM_1 := MPSoC_onchip_memdata0
$(MEM_1)_NAME := onchip_memdata0
...
$(MEM_1)_HIERARCHICAL_PATH := onchip_memdata0
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_memdata0
onchip_memdata0: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
