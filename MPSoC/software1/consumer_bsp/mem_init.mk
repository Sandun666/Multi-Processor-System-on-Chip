...
# Memory: onchip_memdata1
MEM_1 := MPSoC_onchip_memdata1
$(MEM_1)_NAME := onchip_memdata1
...
$(MEM_1)_START := 0x00038000
$(MEM_1)_END := 0x0003ffff
$(MEM_1)_HIERARCHICAL_PATH := onchip_memdata1
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: onchip_memdata1
onchip_memdata1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym

# Memory: onchip_sharedmem
MEM_2 := MPSoC_onchip_sharedmem
$(MEM_2)_NAME := onchip_sharedmem
...
$(MEM_2)_HIERARCHICAL_PATH := onchip_sharedmem
$(MEM_2)_WIDTH := 32
$(MEM_2)_ENDIANNESS := --little-endian-mem
$(MEM_2)_CREATE_LANES := 0

.PHONY: onchip_sharedmem
onchip_sharedmem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
